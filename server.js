...
const interpolierenRouter = require('./api/routes/interpolieren');
...
const messwerterouteRouter = require('./api/routes/messwerte');
const messwerteRouter = require('./api/routes/messwerteroute');
...
app.use('/api/interpolieren', interpolierenRouter);
